(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('mobx'), require('@angular/core'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('mobx-angular', ['exports', 'mobx', '@angular/core', '@angular/router', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['mobx-angular'] = {}, global.mobx, global.ng.core, global.ng.router, global.rxjs.operators));
}(this, (function (exports, mobx, i0, i1, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    MobxAutorunDirective.decorators = [
        { type: i0.Directive, args: [{ selector: '[mobxAutorun]' },] }
    ];
    ...
    MobxReactionDirective.decorators = [
        { type: i0.Directive, args: [{ selector: '[mobxReaction]' },] }
    ];
    ...
    MobxReactionDirective.propDecorators = {
        mobxReaction: [{ type: i0.Input }],
        mobxReactionOptions: [{ type: i0.Input }]
    };

    var RouterStore = /** @class */ (function () {
        function RouterStore(router, activatedRoute) {
            var _this = this;
            this.router = router;
            ...
            router.events
                ...
                .subscribe(function (e) { return _this.routeListener(e); });
        }
        RouterStore.prototype.routeListener = function (event) {
    ...
    RouterStore.ctorParameters = function () { return [
        { type: i1.Router },
